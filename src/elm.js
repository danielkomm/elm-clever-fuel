							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {$: 'Model', a: a, b: b, c: c, d: d, e: e, f: f, g: g, h: h, i: i, j: j, k: k, l: l};
											};
										};
									};
								};
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$Main$Model($author$project$Main$Ready)($author$project$Main$Ready)('')($rundis$elm_bootstrap$Bootstrap$Dropdown$initialState)($rundis$elm_bootstrap$Bootstrap$Dropdown$initialState)($rundis$elm_bootstrap$Bootstrap$Dropdown$initialState)('price')('5')('e5')(false)('')(
			$rundis$elm_bootstrap$Bootstrap$Accordion$initialStateCardOpen('')),
		$elm$core$Platform$Cmd$none);
};
var $author$project$Msg$AccordionState = function (a) {
	return {$: 'AccordionState', a: a};
};
var $author$project$Msg$DropdownFuel = function (a) {
	return {$: 'DropdownFuel', a: a};
};
var $author$project$Msg$DropdownRadius = function (a) {
	return {$: 'DropdownRadius', a: a};
};
var $author$project$Msg$DropdownSort = function (a) {
	return {$: 'DropdownSort', a: a};
};
...
var $author$project$Main$subscriptions = function (_v0) {
	var dropDownStateFuel = _v0.d;
	var dropDownStateSort = _v0.e;
	var dropDownStateRadius = _v0.f;
	var accordionState = _v0.l;
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A2($rundis$elm_bootstrap$Bootstrap$Dropdown$subscriptions, dropDownStateFuel, $author$project$Msg$DropdownFuel),
				A2($rundis$elm_bootstrap$Bootstrap$Dropdown$subscriptions, dropDownStateSort, $author$project$Msg$DropdownSort),
				A2($rundis$elm_bootstrap$Bootstrap$Dropdown$subscriptions, dropDownStateRadius, $author$project$Msg$DropdownRadius),
				A2($rundis$elm_bootstrap$Bootstrap$Accordion$subscriptions, accordionState, $author$project$Msg$AccordionState)
			]));
};
...
var $author$project$Msg$GotCoords = function (a) {
	return {$: 'GotCoords', a: a};
};
var $author$project$Coordinates$Coordinate = F2(
	function (latitude, longitude) {
		return {latitude: latitude, longitude: longitude};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$float = _Json_decodeFloat;
var $author$project$Api$ApiRequest$coordParser = A2(
	$elm$json$Json$Decode$field,
	'referencePosition',
	A3(
		$elm$json$Json$Decode$map2,
		$author$project$Coordinates$Coordinate,
...
var $author$project$Api$ApiRequest$coordinatesParser = A2(
	$elm$json$Json$Decode$field,
	'locations',
	$elm$json$Json$Decode$list($author$project$Api$ApiRequest$coordParser));
...
var $author$project$Api$ApiRequest$loadCoords = function (searchParameter) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, $author$project$Msg$GotCoords, $author$project$Api$ApiRequest$coordinatesParser),
...
var $author$project$Msg$GotStations = function (a) {
	return {$: 'GotStations', a: a};
};
var $author$project$Stations$Station = F8(
	function (brand, dist, price, isOpen, street, houseNumber, postCode, place) {
		return {brand: brand, dist: dist, houseNumber: houseNumber, isOpen: isOpen, place: place, postCode: postCode, price: price, street: street};
	});
...
var $author$project$Api$ApiRequest$stationParser = A9(
	$elm$json$Json$Decode$map8,
	$author$project$Stations$Station,
	A2($elm$json$Json$Decode$field, 'brand', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'dist', $elm$json$Json$Decode$float),
	A2(
		$elm$json$Json$Decode$field,
		'price',
		$elm$json$Json$Decode$maybe($elm$json$Json$Decode$float)),
	A2($elm$json$Json$Decode$field, 'isOpen', $elm$json$Json$Decode$bool),
	A2($elm$json$Json$Decode$field, 'street', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'houseNumber', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'postCode', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'place', $elm$json$Json$Decode$string));
var $author$project$Api$ApiRequest$stationsParser = A2(
	$elm$json$Json$Decode$field,
	'stations',
	$elm$json$Json$Decode$list($author$project$Api$ApiRequest$stationParser));
var $author$project$Api$ApiRequest$loadStations = F5(
	function (lat, lng, rad, sort, gasType) {
		return $elm$http$Http$get(
			{
				expect: A2($elm$http$Http$expectJson, $author$project$Msg$GotStations, $author$project$Api$ApiRequest$stationsParser),
...
var $author$project$Main$sendRequestHelper = function (_v0) {
	var initStations = _v0.a;
	var initCoordinates = _v0.b;
	var searchParameter = _v0.c;
	var dropDownStateFuel = _v0.d;
	var dropDownStateSort = _v0.e;
	var dropDownStateRadius = _v0.f;
	var sort = _v0.g;
	...
	var goToMaps = _v0.k;
	var accordionState = _v0.l;
	switch (initCoordinates.$) {
		case 'Ready':
			return _Utils_Tuple2(
				$author$project$Main$Model(initStations)(initCoordinates)(searchParameter)(dropDownStateFuel)(dropDownStateSort)(dropDownStateRadius)(sort)(radius)(gasType)(isChecked)(goToMaps)(accordionState),
				$elm$core$Platform$Cmd$none);
		case 'Loading':
			return _Utils_Tuple2(
				$author$project$Main$Model(initStations)(initCoordinates)(searchParameter)(dropDownStateFuel)(dropDownStateSort)(dropDownStateRadius)(sort)(radius)(gasType)(isChecked)(goToMaps)(accordionState),
				$elm$core$Platform$Cmd$none);
		case 'Success':
			var list = initCoordinates.a;
			if (!list.b) {
				return _Utils_Tuple2(
					$author$project$Main$Model(initStations)(initCoordinates)(searchParameter)(dropDownStateFuel)(dropDownStateSort)(dropDownStateRadius)(sort)(radius)(gasType)(isChecked)(goToMaps)(accordionState),
					$elm$core$Platform$Cmd$none);
			} else {
				var initCoords = list.a;
				return _Utils_Tuple2(
					$author$project$Main$Model($author$project$Main$Loading)(initCoordinates)(searchParameter)(dropDownStateFuel)(dropDownStateSort)(dropDownStateRadius)(sort)(radius)(gasType)(isChecked)(goToMaps)(accordionState),
					A5(
						$author$project$Api$ApiRequest$loadStations,
						$elm$core$String$fromFloat(initCoords.latitude),
						$elm$core$String$fromFloat(initCoords.longitude),
						radius,
						sort,
						gasType));
			}
		...
		switch (msg.$) {
			...
			case 'GotStations':
				...
				if (result.$ === 'Err') {
					var error = result.a;
					return _Utils_Tuple2(
						$author$project$Main$Model($author$project$Main$Failed)(initCoordinates)(searchParameter)(dropDownStateFuel)(dropDownStateSort)(dropDownStateRadius)(sort)(radius)(gasType)(isChecked)(goToMaps)(accordionState),
						$elm$core$Platform$Cmd$none);
				} else {
						...
						$author$project$Main$Model(
							$author$project$Main$Success(
								A2(
									...
									function (station) {
										return isChecked ? station.isOpen : true;
									},
									stations)))(initCoordinates)(searchParameter)(dropDownStateFuel)(dropDownStateSort)(dropDownStateRadius)(sort)(radius)(gasType)(isChecked)(goToMaps)(accordionState),
						$elm$core$Platform$Cmd$none);
				}
			case 'GetCoords':
				return _Utils_Tuple2(
					$author$project$Main$Model(initStations)($author$project$Main$Loading)(searchParameter)(dropDownStateFuel)(dropDownStateSort)(dropDownStateRadius)(sort)(radius)(gasType)(isChecked)(goToMaps)(accordionState),
					$author$project$Api$ApiRequest$loadCoords(searchParameter));
			case 'GotCoords':
				var result = msg.a;
				if (result.$ === 'Err') {
					var error = result.a;
					return _Utils_Tuple2(
						$author$project$Main$Model(initStations)($author$project$Main$Failed)(searchParameter)(dropDownStateFuel)(dropDownStateSort)(dropDownStateRadius)(sort)(radius)(gasType)(isChecked)(goToMaps)(accordionState),
						$elm$core$Platform$Cmd$none);
				} else {
					var coordinates = result.a;
					return _Utils_Tuple2(
						$author$project$Main$Model(initStations)(
							$author$project$Main$Success(coordinates))(searchParameter)(dropDownStateFuel)(dropDownStateSort)(dropDownStateRadius)(sort)(radius)(gasType)(isChecked)(goToMaps)(accordionState),
						$elm$core$Platform$Cmd$none);
				}
			case 'UpdateTextInput':
				var inputParam = msg.a;
				return _Utils_Tuple2(
					$author$project$Main$Model(initStations)(initCoordinates)(inputParam)(dropDownStateFuel)(dropDownStateSort)(dropDownStateRadius)(sort)(radius)(gasType)(isChecked)(goToMaps)(accordionState),
					$elm$core$Platform$Cmd$none);
			case 'DropdownFuel':
				var state = msg.a;
				return _Utils_Tuple2(
					$author$project$Main$Model(initStations)(initCoordinates)(searchParameter)(state)(dropDownStateSort)(dropDownStateRadius)(sort)(radius)(gasType)(isChecked)(goToMaps)(accordionState),
					$elm$core$Platform$Cmd$none);
			case 'DropdownSort':
				var state = msg.a;
				return _Utils_Tuple2(
					$author$project$Main$Model(initStations)(initCoordinates)(searchParameter)(dropDownStateFuel)(state)(dropDownStateRadius)(sort)(radius)(gasType)(isChecked)(goToMaps)(accordionState),
					$elm$core$Platform$Cmd$none);
			case 'DropdownRadius':
				var state = msg.a;
				return _Utils_Tuple2(
					$author$project$Main$Model(initStations)(initCoordinates)(searchParameter)(dropDownStateFuel)(dropDownStateSort)(state)(sort)(radius)(gasType)(isChecked)(goToMaps)(accordionState),
					$elm$core$Platform$Cmd$none);
			case 'SetGasType':
				var newFuelType = msg.a;
				return $author$project$Main$sendRequestHelper(
					$author$project$Main$Model(initStations)(initCoordinates)(searchParameter)(dropDownStateFuel)(dropDownStateSort)(dropDownStateRadius)(sort)(radius)(newFuelType)(isChecked)(goToMaps)(accordionState));
			case 'SetSortType':
				var newSort = msg.a;
				return $author$project$Main$sendRequestHelper(
					$author$project$Main$Model(initStations)(initCoordinates)(searchParameter)(dropDownStateFuel)(dropDownStateSort)(dropDownStateRadius)(newSort)(radius)(gasType)(isChecked)(goToMaps)(accordionState));
			case 'SetRadiusType':
				var newRadius = msg.a;
				return $author$project$Main$sendRequestHelper(
					$author$project$Main$Model(initStations)(initCoordinates)(searchParameter)(dropDownStateFuel)(dropDownStateSort)(dropDownStateRadius)(sort)(newRadius)(gasType)(isChecked)(goToMaps)(accordionState));
			case 'CheckBoxChecked':
				var isCheckedState = msg.a;
				return $author$project$Main$sendRequestHelper(
					$author$project$Main$Model(initStations)(initCoordinates)(searchParameter)(dropDownStateFuel)(dropDownStateSort)(dropDownStateRadius)(sort)(radius)(gasType)(isCheckedState)(goToMaps)(accordionState));
			case 'GoToMaps':
				var url = msg.a;
				return _Utils_Tuple2(
					$author$project$Main$Model(initStations)(initCoordinates)(searchParameter)(dropDownStateFuel)(dropDownStateSort)(dropDownStateRadius)(sort)(radius)(gasType)(isChecked)(goToMaps)(accordionState),
			...
			default:
				var state = msg.a;
				return _Utils_Tuple2(
					$author$project$Main$Model(initStations)(initCoordinates)(searchParameter)(dropDownStateFuel)(dropDownStateSort)(dropDownStateRadius)(sort)(radius)(gasType)(isChecked)(goToMaps)(state),
					$elm$core$Platform$Cmd$none);
		}
	});
var $elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
var $elm$html$Html$Attributes$style = $elm$virtual_dom$VirtualDom$style;
var $author$project$Style$Style$centerNavigationBar = _List_fromArray(
	[
		A2($elm$html$Html$Attributes$style, 'text-align', 'center'),
		A2($elm$html$Html$Attributes$style, 'position', '-webkit-sticky'),
		A2($elm$html$Html$Attributes$style, 'position', 'sticky')
	]);
var $elm$html$Html$div = _VirtualDom_node('div');
var $author$project$Msg$CheckBoxChecked = function (a) {
	return {$: 'CheckBoxChecked', a: a};
};
...
var $author$project$Main$drawFilterCheckbox = function (isChecked) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rundis$elm_bootstrap$Bootstrap$Form$Checkbox$id('checkbox'),
						$rundis$elm_bootstrap$Bootstrap$Form$Checkbox$onCheck($author$project$Msg$CheckBoxChecked),
						$rundis$elm_bootstrap$Bootstrap$Form$Checkbox$checked(isChecked)
					]),
				'Show only open')
			]));
};
var $author$project$Msg$GetCoords = {$: 'GetCoords'};
...
var $author$project$Style$Style$headerBadge = _List_fromArray(
	[
...
var $author$project$Style$Style$homePageContainer = _List_fromArray(
	[
		...
		A2($elm$html$Html$Attributes$style, 'tranform', 'translate(-50%, -50%'),
		A2($elm$html$Html$Attributes$style, 'height', '375px'),
		A2($elm$html$Html$Attributes$style, 'width', '600px'),
		A2($elm$html$Html$Attributes$style, 'background', '255 255 255'),
		A2($elm$html$Html$Attributes$style, 'overflow', 'hidden'),
		A2($elm$html$Html$Attributes$style, 'border-radius', '20px'),
		A2($elm$html$Html$Attributes$style, 'box-shadow', '0 0 20px 8px #d0d0d0'),
		A2($elm$html$Html$Attributes$style, 'margin-top', '50px')
	]);
var $author$project$Style$Style$homePageContainerSmallHeadingBadge = _List_fromArray(
	[
		A2($elm$html$Html$Attributes$style, 'font-size', '9pt'),
		A2($elm$html$Html$Attributes$style, 'margin-left', '-380px')
	]);
var $author$project$Style$Style$homePageContainerText = _List_fromArray(
	[
...
var $author$project$Msg$UpdateTextInput = function (a) {
...
var $author$project$Style$Style$inputStyle = _List_fromArray(
	[
		$elm$html$Html$Attributes$placeholder('Search location'),
		$elm$html$Html$Events$onInput($author$project$Msg$UpdateTextInput),
		...
		A2($elm$html$Html$Attributes$style, 'box-shadow', '4px 4px 10px rgba(0,0,0,0.06)'),
		A2($elm$html$Html$Attributes$style, 'margin-top', '50px')
	]);
...
var $author$project$Style$Style$searchButton = _List_fromArray(
	[
...
var $author$project$Main$drawHomePageHtml = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'text-align', 'center')
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('CLEVER-FUEL')
						]))
				])),
			A2($elm$html$Html$input, $author$project$Style$Style$inputStyle, _List_Nil),
			A2(
			$rundis$elm_bootstrap$Bootstrap$Button$button,
			_List_fromArray(
				[
					$rundis$elm_bootstrap$Bootstrap$Button$success,
					$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$Msg$GetCoords),
					$rundis$elm_bootstrap$Bootstrap$Button$attrs($author$project$Style$Style$searchButton),
			...
			A2(
			$elm$html$Html$div,
			$author$project$Style$Style$homePageContainer,
			_List_fromArray(
				[
					A2(
					$rundis$elm_bootstrap$Bootstrap$Badge$pillSuccess,
					$author$project$Style$Style$headerBadge,
					_List_fromArray(
						[
							$elm$html$Html$text('WELCOME TO CLEVER-FUEL')
						])),
					A2(
					$elm$html$Html$div,
					_List_Nil,
					_List_fromArray(
						[
							...
							$author$project$Style$Style$homePageContainerSmallHeadingBadge,
							_List_fromArray(
								[
									$elm$html$Html$text('WHAT IS CLEVER-FUEL?')
								]))
						])),
					A2(
					$elm$html$Html$div,
					$author$project$Style$Style$homePageContainerText,
					_List_fromArray(
						[
							$elm$html$Html$text('With Clever fuel you can display the best, cheapest and nearest gas stations in your area. Look for gas stations in your area or throughout Germany and refuel at fair prices!')
						])),
					A2(
					$elm$html$Html$div,
					_List_Nil,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('HOW TO USE CLEVER-FUEL?')
								]))
						])),
					A2(
					$elm$html$Html$div,
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Use the search field to find certain places near you or in Germany and confirm your search with the search button.'),
							A2($elm$html$Html$br, _List_Nil, _List_Nil),
							$elm$html$Html$text('Choose your fuel type to display all gas stations within a radius of 5km.'),
							A2($elm$html$Html$br, _List_Nil, _List_Nil),
							$elm$html$Html$text('Use our filter options to see different fuel types, to obtain the radius or to change the sorting from price to distance or to only see the open gas stations nearby.'),
							A2($elm$html$Html$br, _List_Nil, _List_Nil),
							$elm$html$Html$text('You can use the compass to open the gas station informations at Google Maps and use it for a direct routing.'),
							A2($elm$html$Html$br, _List_Nil, _List_Nil),
							$elm$html$Html$text('By clicking on the name of the gas station you can open the address informations.')
						]))
				]))
		]));
var $author$project$Msg$SetGasType = function (a) {
	return {$: 'SetGasType', a: a};
};
...
var $author$project$Main$drawSelectGasTypes = F2(
	function (dropDownState, value) {
		return A2(
			...
			dropDownState,
			{
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Msg$SetGasType('e5'))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Super E5')
							])),
						A2(
						$rundis$elm_bootstrap$Bootstrap$Dropdown$buttonItem,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Msg$SetGasType('e10'))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Super E10')
							])),
						A2(
						$rundis$elm_bootstrap$Bootstrap$Dropdown$buttonItem,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Msg$SetGasType('diesel'))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Diesel')
							]))
					]),
				options: _List_Nil,
				toggleButton: A2(
				...
				toggleMsg: $author$project$Msg$DropdownFuel
			});
	});
var $author$project$Msg$SetRadiusType = function (a) {
	return {$: 'SetRadiusType', a: a};
};
var $author$project$Main$drawSelectRadius = F2(
	function (dropDownState, value) {
		return A2(
			$rundis$elm_bootstrap$Bootstrap$Dropdown$dropdown,
			dropDownState,
				...
				items: _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Msg$SetRadiusType('1'))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('1km')
							])),
						A2(
						$rundis$elm_bootstrap$Bootstrap$Dropdown$buttonItem,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Msg$SetRadiusType('10'))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('5km')
							])),
						A2(
						$rundis$elm_bootstrap$Bootstrap$Dropdown$buttonItem,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Msg$SetRadiusType('15'))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('15km')
							])),
						A2(
						$rundis$elm_bootstrap$Bootstrap$Dropdown$buttonItem,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Msg$SetRadiusType('20'))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('20km')
							])),
						A2(
						$rundis$elm_bootstrap$Bootstrap$Dropdown$buttonItem,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Msg$SetRadiusType('25'))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('25km')
							]))
					]),
				options: _List_Nil,
				toggleButton: A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Radius: ' + (value + 'km'))
						])),
				toggleMsg: $author$project$Msg$DropdownRadius
			});
	});
var $author$project$Msg$SetSortType = function (a) {
	return {$: 'SetSortType', a: a};
};
...
var $author$project$Main$drawSelectSortType = F2(
	function (dropDownState, value) {
		return A2(
			$rundis$elm_bootstrap$Bootstrap$Dropdown$dropdown,
			dropDownState,
			{
				items: _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Msg$SetSortType('price'))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Msg$SetSortType('dist'))
							]),
						_List_fromArray(
							[
				...
				toggleMsg: $author$project$Msg$DropdownSort
			});
	});
var $author$project$Msg$GoToMaps = function (a) {
	return {$: 'GoToMaps', a: a};
};
...
var $author$project$Style$Style$accordionHeaderDefaultStyle = _List_fromArray(
	[
		A2($elm$html$Html$Attributes$style, 'padding', '0'),
		A2($elm$html$Html$Attributes$style, 'background-color', 'transparent'),
		A2($elm$html$Html$Attributes$style, 'border', '0'),
		A2($elm$html$Html$Attributes$style, 'border-top-color', 'transparent'),
		A2($elm$html$Html$Attributes$style, 'border-top-style', 'none'),
		A2($elm$html$Html$Attributes$style, 'border-top-width', '0px'),
		A2($elm$html$Html$Attributes$style, 'border-right-color', 'transparent'),
		A2($elm$html$Html$Attributes$style, 'border-right-style', 'none'),
		A2($elm$html$Html$Attributes$style, 'border-right-width', '0px'),
		A2($elm$html$Html$Attributes$style, 'border-bottom-color', 'transparent'),
		A2($elm$html$Html$Attributes$style, 'border-bottom-style', 'none'),
		A2($elm$html$Html$Attributes$style, 'border-bottom-width', '0px'),
		A2($elm$html$Html$Attributes$style, 'border-left-color', 'transparent'),
		A2($elm$html$Html$Attributes$style, 'border-left-style', 'none'),
		A2($elm$html$Html$Attributes$style, 'border-left-width', '0px'),
		A2($elm$html$Html$Attributes$style, 'border-image-source', 'unset'),
		A2($elm$html$Html$Attributes$style, 'border-image-slice', 'unset'),
		A2($elm$html$Html$Attributes$style, 'border-image-width', 'unset'),
		A2($elm$html$Html$Attributes$style, 'border-image-outset', 'unset'),
		A2($elm$html$Html$Attributes$style, 'border-image-repeat', 'unset')
	]);
var $author$project$Style$Style$accordionHeadingStyle = _List_fromArray(
	[
...
var $author$project$Style$Style$gasStationAddressStyle = _List_fromArray(
	[
...
var $author$project$Main$drawAccordion = F7(
	function (index, _v0, stationName, stationStreet, stationHouseNumber, stationPostCode, stationPlace) {
		var initStations = _v0.a;
		var initCoordinates = _v0.b;
		var searchParameter = _v0.c;
		var dropDownStateFuel = _v0.d;
								...
								[
									...
									_List_fromArray(
										[
											...
											$author$project$Style$Style$gasStationAddressStyle,
											_List_fromArray(
												[
													$elm$html$Html$text(stationStreet),
													$elm$html$Html$text(' '),
													$elm$html$Html$text(stationHouseNumber),
													$elm$html$Html$text(', '),
													$elm$html$Html$text(
													$elm$core$String$fromInt(stationPostCode)),
													$elm$html$Html$text(' '),
													$elm$html$Html$text(stationPlace)
												]))
										]))
								]),
							header: A2(
								$rundis$elm_bootstrap$Bootstrap$Accordion$header,
								$author$project$Style$Style$accordionHeaderDefaultStyle,
								A2(
									$rundis$elm_bootstrap$Bootstrap$Accordion$toggle,
									$author$project$Style$Style$accordionHeadingStyle,
									_List_fromArray(
										[
											$elm$html$Html$text(
											(stationName === '') ? 'N/A' : stationName)
										]))),
							id: $elm$core$String$fromInt(index),
							options: _List_fromArray(
								[
									$rundis$elm_bootstrap$Bootstrap$Card$attrs($author$project$Style$Style$accordionHeaderDefaultStyle)
								])
						})
					]),
				$rundis$elm_bootstrap$Bootstrap$Accordion$onlyOneOpen(
					$rundis$elm_bootstrap$Bootstrap$Accordion$withAnimation(
						$rundis$elm_bootstrap$Bootstrap$Accordion$config($author$project$Msg$AccordionState)))));
	});
...
var $author$project$Style$Style$userInformationsAboutState = _List_fromArray(
	[
		$rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$ml1,
		A2($elm$html$Html$Attributes$style, 'font-size', '10pt')
	]);
var $author$project$Main$drawTable = function (model) {
	_v0$2:
	while (true) {
		_v0$3:
		while (true) {
									...
									return A2(
										...
										_List_fromArray(
											[
												...
												$author$project$Style$Style$userInformationsAboutState,
												_List_fromArray(
													[
														$elm$html$Html$text('APPLICATION IS READY TO USE')
													]))
											]));
								case 'Loading':
									break _v0$2;
									...
									return A2(
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('FAILED TO LOAD COORDINATES!')
													]))
											]));
							}
						case 'Loading':
							...
							return A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('LOADING STATIONS ...')
											]))
									]));
						case 'Success':
							switch (model.b.$) {
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('FAILED TO LOAD STATIONS!')
								]))
						]));
			}
			var response = model.b.a;
			return A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('PLEASE CHOOSE A FUEL TYPE')
							]))
					]));
		}
		var response = model.a.a;
		var initCoordinates = model.b;
		var searchParameter = model.c;
		var dropDownStateFuel = model.d;
		var dropDownStateSort = model.e;
		var dropDownStateRadius = model.f;
		var sort = model.g;
		var radius = model.h;
		var gasType = model.i;
		var isChecked = model.j;
		var goToMaps = model.k;
		var accordionState = model.l;
		if (!response.b) {
			return A2(
				$rundis$elm_bootstrap$Bootstrap$Badge$badgeDanger,
				$author$project$Style$Style$userInformationsAboutState,
				_List_fromArray(
					[
						$elm$html$Html$text('NO DATA FOUND')
					]));
		} else {
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														A7(
														$author$project$Main$drawAccordion,
														index,
														$author$project$Main$Model($author$project$Main$Loading)(initCoordinates)(searchParameter)(dropDownStateFuel)(dropDownStateSort)(dropDownStateRadius)(sort)(radius)(gasType)(isChecked)(goToMaps)(accordionState),
														station.brand,
														station.street,
												...
												_List_fromArray(
													[
														$elm$html$Html$text(
														$elm$core$String$fromFloat(station.dist) + ' km')
													])),
												A2(
												$rundis$elm_bootstrap$Bootstrap$Table$td,
												_List_Nil,
												_List_fromArray(
													[
														$elm$html$Html$text(
														function () {
															var _v6 = station.price;
															if (_v6.$ === 'Just') {
																var price = _v6.a;
																return $elm$core$String$fromFloat(price) + '€';
															} else {
																return 'N/A';
															}
														}())
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Events$onClick(
																$author$project$Msg$GoToMaps(
																	'https://www.google.de/maps/place/' + (station.street + ('+' + (station.houseNumber + (', ' + ('+' + ($elm$core$String$fromInt(station.postCode) + ('+' + station.place))))))))),
																A2($elm$html$Html$Attributes$style, 'border', 'none'),
																A2($elm$html$Html$Attributes$style, 'background-color', 'transparent'),
																A2($elm$html$Html$Attributes$style, 'cursor', 'pointer')
															]),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('LOADING LOCATION ... ')
					]))
			]));
};
var $author$project$Main$view = function (_v0) {
	...
	switch (initCoordinates.$) {
		case 'Ready':
			return $author$project$Main$drawHomePageHtml;
		case 'Loading':
			return $author$project$Main$drawHomePageHtml;
		case 'Success':
			var coords = initCoordinates.a;
			return A2(
				$elm$html$Html$div,
				$author$project$Style$Style$centerNavigationBar,
				_List_fromArray(
					[
						A2($author$project$Main$drawSelectGasTypes, dropDownStateFuel, gasType),
						A2($author$project$Main$drawSelectSortType, dropDownStateSort, sort),
						A2($author$project$Main$drawSelectRadius, dropDownStateRadius, radius),
						$author$project$Main$drawFilterCheckbox(isChecked),
						$author$project$Main$drawTable(
						$author$project$Main$Model(initStations)(initCoordinates)(searchParameter)(dropDownStateFuel)(dropDownStateSort)(dropDownStateRadius)(sort)(radius)(gasType)(isChecked)(goToMaps)(accordionState))
					]));
		default:
			return $author$project$Main$drawHomePageHtml;
